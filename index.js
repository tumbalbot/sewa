...
mbc = `Selamat Datang di ${metadata.subject}

@${num.split("@")[0]} Jangan Lupa Baca Rules Ya`
}
let buttons = [
{buttonId: `wkwk`, buttonText: {displayText: 'Haii👋'}, type: 1}
]
let buttonMessage = {
...
mbcd = `@${num.split("@")[0]} Meninggalkan ${metadata.subject}`
}
